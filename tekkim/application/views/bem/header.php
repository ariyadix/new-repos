...
<head>
	...
	<title>TEKNIK KIMIA ULM</title>
	<link href="<?= base_url('assets/css/bootstrap.min.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/css/font-awesome.min.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/css/datepicker3.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/css/styles.css') ?>" rel="stylesheet">
	<link rel="icon" rel="icon" href="<?= base_url('assets/img/unlam.png') ?>">
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <div class="profile-userpic">
				<img src="<?= base_url('assets/img/foto.png') ?>" class="img-responsive" alt="">
			</div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
			...
			<?php endif ?>
			<?php if(!empty($this->session->userdata('rektor')) || !empty($this->session->userdata('dekan')) || !empty($this->session->userdata('admin'))): ?>
			<li><a href="<?= base_url('live-count') ?>"><em class="fa fa-database">&nbsp;</em> Live Count</a></li><?php endif ?>
