              ...
              <?= form_open('admin/post', ['class' => 'form-horizontal']) ?>
                <?= validation_errors() ?>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
                    <?= form_input('nama_admin', $input->nama_admin, ['class' => 'form-control', 'placeholder' => 'Masukkan Nama Admin']) ?>
									</div>
								</div>
                ...
                <!-- Name input-->
								<div class="form-group">
									...
									<div class="col-md-9">
                    <?= form_input('username_admin', $input->username_admin, ['class' => 'form-control', 'placeholder' => 'Username']) ?>
									</div>
								</div>
                ...
                <!-- Name input-->
								<div class="form-group">
									...
									<div class="col-md-9">
                    <?= form_password('password_admin', $input->password_admin, ['class' => 'form-control', 'placeholder' => '*****']) ?>
									</div>
								</div>
