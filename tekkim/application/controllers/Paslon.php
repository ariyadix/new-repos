...
defined('BASEPATH') OR exit('No direct script access allowed');
  ...
  class Paslon extends MY_Controller{
    ...
    //  $capres['fakultas_capres'] = $input->fakultas_capres;
 ...
 //     $cawapres['fakultas_cawapres'] = $input->fakultas_cawapres;
 ...
 //     $pas['fakultas_koalisi'] = $this->input->post('fakultas_koalisi', TRUE);
 ...
 //     $capres['fakultas_capres'] = $this->input->post('fakultas_capres', TRUE);
