...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4 ml-1 mr-1">
		<table class="table">
			<thead class="thead-light">
				<tr>
					...
					<th scope="col">NIK</th>
					<th scope="col">Jabatan Kelompok</th>
					<th scope="col">Alamat</th>
					<th scope="col">Hp</th>
					<th scope="col">Tingkat Pendidikan</th>
					<th scope="col">Umur</th>
					<th scope="col">Usaha Selain Perikanan</th>
					<th scope="col">Mulai Usaha Perikanan</th>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo $d['id']; ?></td>
						<td><?php echo $d['id_kelompok']; ?></td>
						<td><?php echo $d['nama']; ?></td>
						<td><?php echo $d['nik']; ?></td>
						<td><?php echo $d['jabatan_kelompok']; ?></td>
						<td><?php echo $d['alamat']; ?></td>
						<td><?php echo $d['hp']; ?></td>
						<td><?php echo $d['tingkat_pendidikan']; ?></td>
						<td><?php echo $d['umur']; ?></td>
						<td><?php echo $d['usaha_selain_perikanan']; ?></td>
						<td><?php echo $d['mulai_usaha_perikanan']; ?></td>
						<td><img src="../file/photo/<?php echo $d['photo']; ?>" width="150px" height="150px" /></td>
						<td>
