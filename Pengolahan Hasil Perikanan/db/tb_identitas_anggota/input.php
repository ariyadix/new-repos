...
<head>
	...
	<title>Penginputan Data Identitas Anggota</title>
...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Identitas Anggota</h2>
		<form method="post" action="tambah_aksi.php" name="formAnggota" enctype="multipart/form-data" onsubmit="return validateForm()">
			<div class="form-group">
				<input type="hidden" name="id">
				<label>ID Kelompok : <br></label>
				<input type="text" name="id_kelompok" class="form-control" placeholder="Masukan ID Kelompok" required />
			</div>
			<div class="form-group">
				<label>Nama : <br></label>
			...
			<div class="form-group">
				<label>NIK : <br></label>
				<input type="number" min="0" max="9999999999999999" pattern="[0-9]{16}" name="nik" class="form-control" placeholder="Masukan NIK" required />
			</div>
			<div class="form-group">
				...
				<select name="jabatan_kelompok" class="form-control" placeholder="Masukkan Jabatan Kelompok" required>
					<option value="0">Pilih Jabatan Kelompok</option>
			...
			<div class="form-group">
				...
				<input type="tel" name="hp" class="form-control" placeholder="Masukkan No HP" required />
			</div>
			<div class="form-group">
				...
				<select name="tingkat_pendidikan" class="form-control" placeholder="Masukkan Tingkat Pendidikan" required>
					...
					<option value="SMA/SLTA/MA/SMK">SMA/SLTA/MA/SMK</option>
			...
			<div class="form-group">
				...
				<input type="text" name="usaha_selain_perikanan" class="form-control" placeholder="Masukkan Usaha Selain Perikanan" required />
			</div>
			<div class="form-group">
				<label>Mulai Usaha Perikanan : <br></label>
				<input type="number" min="0" max="9999" pattern="[0-9]{4}" name="mulai_usaha_perikanan" class="form-control" placeholder="Masukkan Mulai Usaha Perikanan" required />
			</div>
			<div class="form-group">
				<label>Foto : </label><br>
				<small style="align: left; color:grey;">Tambahkan Foto</small>
