...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Produk Olahan</h2>
		<form method="post" action="tambah_aksi.php" enctype="multipart/form-data">
			<div class="form-group">
				<input type="hidden" name="Id">
				<label>Nama : <br></label>
				<input type="text" name="nama" class="form-control" placeholder="Masukan Nama Produk Olahan" required />
			</div>
			<div class="form-group">
				<label>ID Ikan : <br></label>
				<input type="text" name="Id_ikan" class="form-control" placeholder="Masukan ID Ikan" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="cara_pembuatan" class="form-control" placeholder="Masukan Cara Pembuatan" required />
			</div>
