<?php
include('../koneksi.php');
$data = mysqli_query($koneksi, "select*from tb_produk_olahan where Id=" . "'" . $_GET['id'] . "'");
?>
<!DOCTYPE html>
<html>
	...
	<div class="content container mt-4 mb-4">
		...
		?>
			<form method="post" action="edit_aksi.php" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label>ID Ikan : <br></label>
					<input type="text" value="<?php echo $d['Id_ikan']; ?>" name="Id_ikan" class="form-control" placeholder="Masukan ID Ikan" required />
				</div>
				<div class="form-group">
					<label>Bahan : <br></label>
					<input type="text" value="<?php echo $d['bahan']; ?>" name="bahan" class="form-control" placeholder="Masukan Bahan" required />
				</div>
				<div class="form-group">
					<label>Cara Pembuatan : <br></label>
					<input type="text" value="<?php echo $d['cara_pembuatan']; ?>" name="cara_pembuatan" class="form-control" placeholder="Masukan Cara Pembuatan" required />
				</div>
