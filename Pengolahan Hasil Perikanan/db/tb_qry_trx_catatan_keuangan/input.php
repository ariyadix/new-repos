...
<head>
	...
	<title>Penginputan Data Transaksi Keuangan</title>
...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Transaksi Keuangan</h2>
		<form method="post" name="formCttKeuangan" onsubmit="return validateForm()" action="tambah_aksi.php" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" name="uraian" class="form-control" placeholder="Masukan Uraian" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<select name="kategori" class="form-control" placeholder="Masukkan Kategori" required>
					...
					<option value="Kas Kelompok">Kas Kelompok</option>
				</select>
			</div>
			<div class="form-group">
