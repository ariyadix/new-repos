<?php
include('../koneksi.php');
$data = mysqli_query($koneksi, "select*from tb_kemasan_produk where Id=" . "'" . $_GET['id'] . "'");
?>
<!DOCTYPE html>
<html>
...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Edit Data Kemasan Produk</h2>
		<?php
		...
		?>
			<form method="post" action="edit_aksi.php" enctype="multipart/form-data">
				<div class="form-group">
					...
					<label>Ukuran Kemasan : <br></label>
					<input type="text" value="<?php echo $d['ukuran_kemasan']; ?>" name="ukuran_kemasan" class="form-control" placeholder="Masukan Ukuran Kemasan" required />
				</div>
				<div class="form-group">
					<label>Keterangan Kemasan : <br></label>
					<input type="text" value="<?php echo $d['keterangan_kemasan']; ?>" name="keterangan_kemasan" class="form-control" placeholder="Masukan Keterangan Kemasan" required />
				</div>
