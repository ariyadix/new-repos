...
<head>
	...
	<title>Penginputan Data Kemasan Produk</title>
...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Kemasan Produk</h2>
		<form method="post" action="tambah_aksi.php" enctype="multipart/form-data">
			<div class="form-group">
				<input type="hidden" name="id">
				<label>Ukuran Kemasan : <br></label>
				<input type="text" name="ukuran_kemasan" class="form-control" placeholder="Masukan Ukuran Kemasan" required />
			</div>
			<div class="form-group">
				<label>Keterangan Kemasan : <br></label>
				<input type="text" name="keterangan_kemasan" class="form-control" placeholder="Masukan Keterangan Kemasan" required />
			</div>
