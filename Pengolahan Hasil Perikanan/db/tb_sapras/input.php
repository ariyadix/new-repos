...
<head>
	...
	<title>Penginputan Data Sapras</title>
...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Sapras</h2>
		<form method="post" action="tambah_aksi.php" name="formSapras" enctype="multipart/form-data" onsubmit="return validateForm()">
			...
			<div class="form-group">
				...
				<input type="date" name="tanggal_terima" class="form-control" placeholder="Masukkan Tanggal Terima" required />
			</div>
			<div class="form-group">
				...
				<select name="keterangan" class="form-control" placeholder="Masukkan Keterangan" required>
					...
					<option value="Milik Anggota">Milik Anggota</option>
					<option value="Milik Kelompok">Milik Kelompok</option>
				</select>
			</div>
			<div class="form-group">
				<label>Ukuran : <br></label>
				<input type="text" name="ukuran" class="form-control" placeholder="Masukkan Ukuran" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<select name="kondisi_barang" class="form-control" placeholder="Masukkan Kondisi Barang" required>
					...
					<option value="Di Hapus">Di Hapus</option>
				</select>
			</div>
			<div class="form-group">
				<label>Foto : </label><br>
