<?php
include('../koneksi.php');
$data = mysqli_query($koneksi, "select*from tb_bukutamu where Id=" . "'" . $_GET['id'] . "'");
?>
<!DOCTYPE html>
<html>
		...
		?>
			<form method="post" name="formCttKeuangan" onsubmit="return validateForm()" action="edit_aksi.php" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" value="<?php echo $d['nama_hp']; ?>" name="nama_hp" class="form-control" placeholder="Masukan Nama dan No Hp" required />
				</div>
				<div class="form-group">
					<label>Jabatan : <br></label>
					<input type="text" value="<?php echo $d['jabatan']; ?>" name="jabatan" class="form-control" placeholder="Masukan Jabatan" required />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" value="<?php echo $d['kesan']; ?>" name="kesan" class="form-control" placeholder="Masukan Kesan" required />
				</div>	
				<div class="form-group">
					<label>Pesan : <br></label>
					<input type="text" value="<?php echo $d['pesan']; ?>" name="pesan" class="form-control" placeholder="Masukkan Pesan" required />
				</div>
				<div class="form-group">
					<label>Tanda Tangan : </label><br>
					<img src="../file/photo/<?php echo $d['photo']; ?>" width="100px" height="100px" />
					<br><small style="align: left; color:grey;">Ganti Tanda Tangan</small>
