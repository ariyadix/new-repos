		...
		<table class="table">
			<thead class="thead-light">
				<tr>
					...
					<th scope="col">ID Produk Olahan</th>
					<th scope="col">ID Kemasan Produk</th>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo $d['id_trx']; ?></td>
						<td><?php echo $d['tanggal']; ?></td>
						<td><?php echo $d['uraian']; ?></td>
						<td><?php echo $d['volume']; ?></td>
						<td><?php echo $d['id_produk_olahan']; ?></td>
						<td><?php echo $d['id_kemasan_produk']; ?></td>
