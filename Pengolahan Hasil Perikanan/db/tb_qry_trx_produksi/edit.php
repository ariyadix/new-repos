<?php
include('../koneksi.php');
$data = mysqli_query($koneksi, "select*from tb_qry_trx_produksi where Id=" . "'" . $_GET['id'] . "'");
?>
<!DOCTYPE html>
<html>
		...
		?>
			<form method="post" action="edit_aksi.php" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" value="<?php echo $d['tanggal']; ?>" name="tanggal" class="form-control" placeholder="Masukan Jabatan Kelompok" required />
				</div>
				<div class="form-group">
					<label>Uraian : <br></label>
					<input type="text" value="<?php echo $d['uraian']; ?>" name="uraian" class="form-control" placeholder="Masukkan Alamat" required />
				</div>
				<div class="form-group">
					<label>ID Produk Olahan: <br></label>
					<input type="text" value="<?php echo $d['id_produk_olahan']; ?>" name="id_produk_olahan" class="form-control" placeholder="Masukkan ID Produk Olahan" required />
				</div>
				<div class="form-group">
					<label>ID Kemasan Produk : <br></label>
					<input type="text" value="<?php echo $d['id_kemasan_produk']; ?>" name="vid)kemasan_produk" class="form-control" placeholder="Masukkan ID Kemasan Produk" required />
				</div>
				<div class="form-group">
					<label>Volume : <br></label>
					<input type="text" value="<?php echo $d['volume']; ?>" name="volume" class="form-control" placeholder="Masukkan No HP" required />
				</div>
				<div class="form-group">
					<label>Lokasi : <br></label>
					<input type="text" value="<?php echo $d['lokasi']; ?>" name="lokasi" class="form-control" placeholder="Masukkan Tingkat Pendidikan" required />
				</div>
				<div class="form-group">
					<label>Keterangan : <br></label>
					<input type="text" value="<?php echo $d['keterangan']; ?>" name="keterangan" class="form-control" placeholder="Masukkan Umur" required />
				</div>
