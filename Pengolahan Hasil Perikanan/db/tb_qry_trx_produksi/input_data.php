...
<head>
	...
	<title>Penginputan Data Transaksi Produksi</title>
...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Rencana Transaksi</h2>
		<form method="post" action="tambah_aksi.php" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" name="id_trx" class="form-control" placeholder="Masukan ID Transaksi" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="id_produk_olahan" class="form-control" placeholder="Masukkan ID Produk Olahan" required />
			</div>
			<div class="form-group">
				<label>ID Kemasan Produk : <br></label>
				<input type="text" name="id_kemasan_produk" class="form-control" placeholder="Masukkan ID Kemasan Produk" required />
			</div>
			<div class="form-group">
				<label>Volume <br></label>
				<input type="text" name="volume" class="form-control" placeholder="Masukkan volume" required />
			</div>
			<div class="form-group">
