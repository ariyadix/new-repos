			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><a href="../file/surat/<?php echo $d['upload_surat']; ?>" target=”_blank”>Lihat Surat</a></td>
						<td><?php echo $d['status_kelompok']; ?></td>
						<td><?php echo $d['titik_lokasi']; ?></td>
						<td><?php echo $d['alamat']; ?></td>
						<td><?php echo $d['penyuluh_pendamping']; ?></td>
						<td><img src="../file/logo/<?php echo $d['logo_kelompok']; ?>" width="100px" height="100px" /></td>
					</tr>
				<?php
				}
				?>
