...
<head>
	...
	<title>Penginputan Data Ikan</title>
	...
	<div class="content container mt-4 mb-4">
		...
		<form method="post" action="tambah_aksi.php" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" name="keterangan_ikan" class="form-control" placeholder="Masukan Keterangan Ikan" required />
			</div>
			<div class="form-group">
				<label>Website : <br></label>
				<input type="url" name="website" class="form-control" placeholder="Masukan Website" required />
			</div>
