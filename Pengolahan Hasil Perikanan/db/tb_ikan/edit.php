<?php
include('../koneksi.php');
$data = mysqli_query($koneksi, "select*from tb_ikan where Id=" . "'" . $_GET['id'] . "'");
?>
<!DOCTYPE html>
<html>
		...
		?>
			<form method="post" action="edit_aksi.php" enctype="multipart/form-data">
				<div class="form-group">
					...
					<label>Nama Ikan : <br></label>
					<input type="text" value="<?php echo $d['nama_ikan']; ?>" name="nama_ikan" class="form-control" placeholder="Masukan Nama Ikan" required />
				</div>
				<div class="form-group">
					<label>Keterangan Ikan : <br></label>
					<input type="text" value="<?php echo $d['keterangan_ikan']; ?>" name="keterangan_ikan" class="form-control" placeholder="Masukan Keterangan Ikan" required />
				</div>
				<div class="form-group">
					<label>Website : <br></label>
					<input type="url" value="<?php echo $d['website']; ?>" name="website" class="form-control" placeholder="Masukan Website" required />
				</div>
