<?php
include('../koneksi.php');
$data = mysqli_query($koneksi, "select*from tb_qry_trx_notulen where Id=" . "'" . $_GET['id'] . "'");
?>
<!DOCTYPE html>
<html>
		...
		?>
			<form method="post" name="formCttKeuangan" onsubmit="return validateForm()" action="edit_aksi.php" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" value="<?php echo $d['keterangan']; ?>" name="keterangan" class="form-control" placeholder="Masukan Keterangan" required />
				</div>	
				<div class="form-group">
					<label>Jumlah Hadir : <br></label>
					<input type="text" value="<?php echo $d['jumlah_hadir']; ?>" name="jumlah_hadir" class="form-control" placeholder="Masukkan Jumlah Hadir" required />
				</div>
				<div class="form-group">
					<label>Foto : </label><br>
