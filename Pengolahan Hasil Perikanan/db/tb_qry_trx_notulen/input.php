...
<head>
	...
	<title>Penginputan Data Transaksi Surat</title>
...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Transaksi Surat</h2>
		<form method="post" name="formCttKeuangan" onsubmit="return validateForm()" action="tambah_aksi.php" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" name="jumlah_hadir" class="form-control" placeholder="Masukkan Jumlah Hadir" required>
			</div>
			<div class="form-group">
				<label>Foto : </label><br>
