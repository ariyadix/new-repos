...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		...
		<form method="post" name="formTrx" onsubmit="return validateForm()" action="tambah_aksi.php" enctype="multipart/form-data">
			<div class="form-group">
				...
				<select name="transaksi" class="form-control" placeholder="Masukkan Transaksi" required>
					...
					<option value="Rencana Kelompok">Rencana Kelompok</option>
					<option value="Produksi">Produksi</option>
					<option value="Penggunaan Alat Tangkap">Penggunaan Alat Tangkap</option>
					<option value="Agenda Surat">Agenda Surat</option>
					<option value="Inventaris Barang">Inventaris Barang</option>
					<option value="Notulen Rapat">Notulen Rapat</option>
					<option value="Catatan Keuangan">Catatan Keuangan</option>
			...
			<div class="form-group">
				...
				<input type="text" name="keterangan_trx" class="form-control" placeholder="Masukan Keterangan Transaksi" required />
			</div>
