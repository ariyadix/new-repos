<?php
include('../koneksi.php');
$data = mysqli_query($koneksi, "select*from tb_trx_sarpras where Id=" . "'" . $_GET['id'] . "'");
?>
<!DOCTYPE html>
<html>
		...
		?>
			<form method="post" action="edit_aksi.php" enctype="multipart/form-data">
				<div class="form-group">
					...
					<label>ID Sarpras : <br></label>
					<input type="text" value="<?php echo $d['id_sarpras']; ?>" name="id_sarpras" class="form-control" placeholder="Masukan ID SarPras" required />
				</div>
				<div class="form-group">
					<label>Tanggal : <br></label>
					<input type="text" value="<?php echo $d['tanggal']; ?>" name="tanggal" class="form-control" placeholder="Masukan Tanggal" required />
				</div>
				<div class="form-group">
					<label>Uraian Kegiatan : <br></label>
					<input type="text" value="<?php echo $d['uraian_kegiatan']; ?>" name="uraian_kegiatan" class="form-control" placeholder="Masukan Uraian Kegiatan" required />
				</div>
				<div class="form-group">
					<label>Kondisi : <br></label>
					<input type="text" value="<?php echo $d['kondisi']; ?>" name="kondisi" class="form-control" placeholder="Masukan Kondisi" required />
				</div>
				<div class="form-group">
					<label>Pemeriksa : <br></label>
					<input type="text" value="<?php echo $d['pemeriksa']; ?>" name="pemeriksa" class="form-control" placeholder="Masukkan Pemeriksa" required />
				</div>
				<div class="form-group">
