...
<body id="page-top" bgcolor="red">
	<div class="content container mt-4 mb-4">
		<h2>Input Data Sarana dan Prasarana</h2>
		<form method="post" action="tambah_aksi.php" enctype="multipart/form-data">
		<div class="form-group">
				<input type="hidden" name="id">
				<label>ID Sarana dan Prasarana : <br></label>
				<input type="text" name="id_sarpras" class="form-control" placeholder="Masukan ID Sarana dan Prasarana" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="uraian_kegiatan" class="form-control" placeholder="Masukkan Uraian Kegiatan" required />
			</div>
			<div class="form-group">
				<label>Kondisi : <br></label>
				<input type="text" name="kondisi" class="form-control" placeholder="Masukkan Kondisi" required />
			</div>
			<div class="form-group">
				<label>Pemeriksa : <br></label>
				<input type="text" name="pemeriksa" class="form-control" placeholder="Masukkan Pemeriksa" required />
			</div>
			<div class="form-group">
