                            ...
                            <div class="modal-body">
                               <form action="proses.php?proses=tambah&id=" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="formgroup">
                                        ...
                                        <input type="text" name="promotor" class="form-control" placeholder="Silahkan Masukan Nama Promotor"required>
                                    </div>
                                    <div class="formgroup">
                                        <label>Co Promotor 1</label>
                                        <input type="text" name="copromotor1" class="form-control" placeholder="Silahkan Masukan Nama Co Promotor 1"required>
                                    </div>
                                    <div class="formgroup">
                                        <label>Co Promotor 2</label>
                                        <input type="text" name="copromotor2" class="form-control" placeholder="Silahkan Masukan Nama Co Promotor 2"required>
                                    </div>
                                    <div class="formgroup">
                                        <label>Penguji Int 1</label>
                                        <input type="text" name="pengujiint1" class="form-control" placeholder="Silahkan Masukan Nama Penguji Internal 1"required>
                                    </div>
                                    <div class="formgroup">
                                        <label>Penguji Int 2</label>
                                        <input type="text" name="pengujiint2" class="form-control" placeholder="Silahkan Masukan Nama Penguji Internal 2"required>
                                    </div>
                                    <div class="formgroup">
                                        <label>Penguji Int 3</label>
                                        <input type="text" name="pengujiint3" class="form-control" placeholder="Silahkan Masukan Nama Penguji Internal 3"required>
                                    </div>
                                    <div class="formgroup">
                                        <label>Penguji Eksternal</label>
                                        <input type="text" name="pengujieks" class="form-control" placeholder="Silahkan Masukan Nama Penguji Eksternal"required>
                                    </div>
                                    <div class="formgroup">
