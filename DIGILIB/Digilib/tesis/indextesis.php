                            ...
                            <div class="modal-body">
                               <form action="proses.php?proses=tambah&id=" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="formgroup">
                                        ...
                                        <input type="text" name="penguji3" class="form-control" placeholder="Silahkan Masukan Nama Penguji 3" required>
                                    </div>
                                    <div class="formgroup">
                                    ...
                                    <!--<div class="formgroup">-->
                                    <!--    <label>Tahun Penelitian</label>-->
                                    <!--    <input type="year" name="tahunpenelitian" class="form-control" placeholder="Silahkan Masukan Tahun Penelitian" required>-->
                                    <!--</div>-->
                                    <!--<div class="formgroup">-->
